...
ALERT_DEFINITIONS = {
    ...
    AlertType.LOW_STOCK: AlertDefinition("low stock", AlertSeverity.MEDIUM, "alert_for_low", stock_rank=200),
    ...
    AlertType.STALE_COUNT: AlertDefinition("stale counts", AlertSeverity.LOW, "alert_for_stale_count", discrete_event=True),
    AlertType.RARE_TAKEOUT: AlertDefinition("rare takeouts", AlertSeverity.LOW, "alert_for_rare_takeout", discrete_event=True),
