...
from app.auth.models import Users, UserAlerts, UserLocations, UserCategories
...
def paginate_display(items: List[Any], 
                    display_function: Callable[[Any, int], None], 
    ...
    while True:
        ...
        print("\nOptions:")
        if total_pages > 1:
            print(f"n - Next page" if current_page < total_pages else "")
            print(f"p - Previous page" if current_page > 1 else "")
